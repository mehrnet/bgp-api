...
// Materialized CIDR covers for every source range. The API uses this table for
// longest-prefix lookups instead of scanning a range index across millions of rows.
export const lookupPrefixes = sqliteTable(
  "lookup_prefixes",
  {
